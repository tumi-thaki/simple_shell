 ...
 *
 * Return: a pointer to the stored command or NULL for error
*/
 ...
 *         the exit value of the last executed command otherwise
*/
 ...
 *
 * Return: -2 if ';', '&&', or '||' is placed at an invalid position
 *	   0 otherwise
*/
